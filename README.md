...
> **Note**: All demo screenshots are now properly linked and will display correctly in the README.
...
<div align="center">
  <img src="images/demo/demo-threat-detection-single.png" alt="Kernel Event Logs" width="600"/>
  <p><em>Kernel Events: Real-time security event logging with color-coded severity levels</em></p>
</div>

#### Chaos Monkey - Threat Injection
<div align="center">
  <img src="images/demo/demo-security-lockdown.png" alt="Chaos Monkey Panel" width="400"/>
...
**Note**: All 15 demo screenshots are now properly linked and will display correctly in the README on GitHub. The images showcase:
- System Design Mode interface and configuration
- Architecture generation (specification and code modes)
- Processing states and loading animations
- Live Simulation Mode with secure kiosk environment
- Network filtering (allowed/blocked scenarios)
- Real-time threat detection (single and multiple threats)
- Security lockdown states
- Various threat scenarios (Chrome, Cheat Engine, Discord, Registry)
- Kernel event logging and Chaos Monkey panel
